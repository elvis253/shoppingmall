...
header('location:login.php');
	...
	if (isset($_POST['submit'])) {
		...
		unset($_SESSION['cart']);
		$idnouser=$_SESSION['id'];
		$useremail="SELECT email FROM users WHERE id=$idnouser";
		$result=$con->query($useremail);
		if($result->num_rows>0){
			while($row=$result->fetch_assoc()){
				...
				$header = "From:elvisarakaogesa@gmail.com \r\n";  
				$feedback = mail($to,$subject,$message,$header);
				//if($feedback=true) {
					//echo "thank u for buying with us ";
				//}else{
